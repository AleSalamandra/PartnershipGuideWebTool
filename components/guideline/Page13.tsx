...
interface SceneProfile {
  ...
  /*
    ...
    Tilt is NOT generated by generic
    dynamic / sporty personalities.

    It is reserved for intentionally
...
function buildSceneProfile(
  ...
  const profile:
    ...
    /*
      ...
      This avoids the random
      crooked-card feeling.
    */
    ...
    (trait) => {
      switch (trait) {
        ...
        case "dynamic":
          ...
          /*
            Dynamic affects rhythm,
            scale and directional graphics.

            It does NOT rotate UI cards.
          */
        ...
        case "sporty":
          ...
          /*
            Sporty can create speed lines,
            data and directional systems,
            but containers remain aligned.
          */
...
function getExpressiveRotation(
  ...
  /*
    ...
    The system needs a genuinely
    playful / experimental personality
    before alignment starts to break.
  */
  ...
  return (
    <>
      ...
      {/* LARGE DECORATIVE FRAME
          ...
          Straight unless the effective
          personality is explicitly
...
function AccentLines({
  ...
  /*
    ...
    Lines are straight by default.

    Only explicitly expressive
    personalities may rotate the system.
  */
